...
urlpatterns = [
    ...
    path("<int:pk>/edit_schedules", views.EditSchedulesView.as_view(), name="edit_schedules"),
    # path(
    ...
    path("<int:testitem_id>/edit_testitems", views.edit_testitems, name="edit_testitems"),
    path("add_testitems", views.add_testitems, name="add_testitems"),
    path("<int:testitem_id>/delete_testitems", views.delete_testitems, name="delete_testitems"),
    ################# CustProducts #################
    path("custproducts", views.custproducts, name="custproducts"),
    path("<int:customer_id>/edit_customers", views.edit_customers, name="edit_customers"),
